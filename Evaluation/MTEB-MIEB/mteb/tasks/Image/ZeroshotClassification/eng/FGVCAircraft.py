...
class FGVCAircraftZeroShotClassification(AbsTaskZeroshotClassification):
    metadata = TaskMetadata(
        ...
        dataset={
            ...
            "path": "Multimodal-Fatima/FGVC_Aircraft_test",
            # "revision": "91860adfc9a09aabca5cddb5247442109b38e213",
            "revision": "7aed01f3cbf8565946dff6ab186e637b31999ed2",
    ...
    label_column_name: str = "label"  ## could be family, manufacturer, or variant. Variant has the higher number of classes.
